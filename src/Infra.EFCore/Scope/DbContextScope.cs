                        ...
                        if (stateInParentScope != null)
                        {
                            ...
                            if (stateInParentScope.EntityState == EntityState.Unchanged)
                            {
                                throw new NotImplementedException(
                                    "There is no way of refreshing entities between DbContexts in EF7.");
...
" + Environment.StackTrace;
        ...
        private static AsyncLocal<InstanceIdentifier> _storeLocal = new AsyncLocal<InstanceIdentifier>();
        ...
        internal static void SetAmbientScope(DbContextScope newAmbientScope)
        {
            ...
            var current = _storeLocal?.Value;// CallContext.LogicalGetData(AmbientDbContextScopeKey) as InstanceIdentifier;
            ...
            _storeLocal.Value = newAmbientScope._instanceIdentifier;
        ...
        {
            var current = _storeLocal.Value;// CallContext.LogicalGetData(AmbientDbContextScopeKey) as InstanceIdentifier;
            _storeLocal.Value = null;// CallContext.LogicalSetData(AmbientDbContextScopeKey, null);
        ...
        internal static DbContextScope GetAmbientScope()
        {
            ...
            var instanceIdentifier = _storeLocal?.Value;// CallContext.LogicalGetData(AmbientDbContextScopeKey) as InstanceIdentifier;
