...
namespace Borg.Infra.Core
{
    ...
    {
        private static readonly MethodInfo _fieldInfoSetValueMethod = typeof(FieldInfo).GetMethod("SetValue", new[] { TypeHelper.ObjectType, TypeHelper.ObjectType });
        private static readonly MethodInfo _dictionaryContainsKey = typeof(Dictionary<object, object>).GetMethod("ContainsKey");
        private static readonly MethodInfo _dictionaryGetItem = typeof(Dictionary<object, object>).GetMethod("get_Item");
        private static readonly MethodInfo _getTypeClonerMethodInfo = typeof(ObjectExtensions).GetMethod("GetTypeCloner", BindingFlags.NonPublic | BindingFlags.Static);
        private static readonly MethodInfo _getTypeMethodInfo = TypeHelper.ObjectType.GetMethod("GetType");
        private static readonly MethodInfo _invokeMethodInfo = typeof(Func<object, Dictionary<object, object>, object>).GetMethod("Invoke");
