...
namespace Borg
{
    public static class StorageExtensions
    {
        ...
        public static IFileSpec ToSpec(this FileInfo info, string textToRemoveFomFulPath = "")
        {
            var fullPath = (string.IsNullOrWhiteSpace(textToRemoveFomFulPath)) ? info.FullName : info.FullName.Replace(textToRemoveFomFulPath, string.Empty);
            return new FileSpec(fullPath, info.Name, info.CreationTimeUtc, info.LastWriteTimeUtc, info.LastAccessTimeUtc, info.Length);
        }
    }
}