...
{
    public abstract class ContextEmbeddedReadWriteRepositoryWithAutoSave<T, TDbContext> :
        ...
        where T : class
    {
        ...
        protected ContextEmbeddedReadWriteRepositoryWithAutoSave(TDbContext dbContext)
        {
