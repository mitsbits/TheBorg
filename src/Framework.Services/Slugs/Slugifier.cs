...
namespace Borg.Framework.Services
{
    ...
    internal class Slugifier : FrameworkService, ISlugifierService
    {
        private readonly IEnumerable<InternationalCharacterToASCIIService> _internationalCharacterMappers;

        protected Slugifier(IEnumerable<InternationalCharacterToASCIIService> internationalCharacterMappers)
        {
