...
{
    public abstract class ContextScopedQueryRepository<T, TDbContext> :
        BaseQueryRespository<T, TDbContext>
        ...
        where T : class
    {
        ...
        protected ContextScopedQueryRepository(IAmbientDbContextLocator ambientDbContextLocator)
        {
